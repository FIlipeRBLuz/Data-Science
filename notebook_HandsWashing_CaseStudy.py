...
ax = before_washing.plot(x='date',y='proportion_deaths', label='Before Handwashing', color='blue')
after_washing.plot(x='date', y='proportion_deaths', label='After Handwashing', ax=ax, color='red')
ax.y_label = ("Proportion deaths")
plt.show()
...
confidence_interval = pd.Series(boot_mean_diff).quantile([0.025,0.95])
confidence_interval
